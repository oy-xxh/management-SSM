...
<body class="childrenBody" style="margin: 1%">
	<blockquote class="layui-elem-quote">
		<p>欢迎使用信息发布后台系统！</p>
		<p>码云地址：<a href="https://gitee.com/duxiaod/irs-maven" target="_blank">https://github.com/oy-xxh</a>&nbsp;&nbsp;&nbsp;记得点个star哦!</p>
		<p>
			作者QQ：<a href="tencent://message/?uin=1346551537&Site=QQ交谈&Menu=yes"target="blank"><img border="0"src="http://wpa.qq.com/pa?p=1:593151321:7" alt="QQ1346551537" width="71" height="24" /></a>
</br>
			QQ交流群：<span style="color: red">17671180581</span> 需要的加一下共同学习！
		</p>
	</blockquote>
